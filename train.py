...
if __name__ == '__main__':
    ...
    parser.add_argument('--data', type=str, default='/mnt/data/lhy/code/multispectral-object-detection/data/multispectral/LLVIP.yaml', help='data.yaml path')
    parser.add_argument('--hyp', type=str, default='/mnt/data/lhy/code/multispectral-object-detection/data/hyp.scratch.yaml', help='hyperparameters path')
