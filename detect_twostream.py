...
logging.basicConfig(
    ...
    filename='multi_object.log',  # 日志文件
    filemode='a'  # 追加模式 ('w' 会覆盖文件)
)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--weights', nargs='+', type=str, default='./ckpts/yolov5l_flir_aligned.pt', help='model.pt path(s)')
    ...
    parser.add_argument('--conf-thres', type=float, default=0.78, help='object confidence threshold')
